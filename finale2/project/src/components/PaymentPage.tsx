...
const PaymentPage = () => {
  ...
  const advanceAmount = 500; // Fixed advance amount
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center py-2 border-b border-gray-700">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-gray-400">(Including ₹50/- convenience fee)</p>
                    </div>
                  </div>
                  <div className="flex justify-between items-center py-2">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-gray-400">(Final amount negotiable — to be paid at venue)</p>
                    </div>
                  </div>
                </div>
